...
// workspace containing every Calypso runtime package), and
...
// started seeing two `calypso-runtime`-shaped packages (duplicate
...
function pathsFor(workspaceDir) {
  return {
    ...
    userPath: pathResolve(workspaceDir, 'src', 'Calypso', 'User.purs'),
...
//     the user already sees from Calypso/User.purs,
