module Calypso.Frontend.ValueView
  ( render
  ) where
...
-- | Recursively render a CalypsoValue as Halogen HTML. The classes
...
render :: forall w i. CalypsoValue -> HH.HTML w i
render = case _ of
...
renderArray :: forall w i. Array CalypsoValue -> HH.HTML w i
renderArray xs =
...
-- string values etc.
renderRecord :: forall w i. Array (Tuple String CalypsoValue) -> HH.HTML w i
renderRecord fields =
...
renderCtor :: forall w i. String -> Array CalypsoValue -> HH.HTML w i
...
renderArg :: forall w i. CalypsoValue -> HH.HTML w i
