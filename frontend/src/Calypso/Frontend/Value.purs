...
-- | agreed with `Calypso.Runtime.CalypsoValue` (in the runtime
...
data CalypsoValue
  ...
  | PVNumber Number
  | PVString String
  | PVArray (Array CalypsoValue)
  | PVCtor String (Array CalypsoValue)
  | PVRecord (Array (Tuple String CalypsoValue))
  | PVRaw String
...
encode :: CalypsoValue -> String
encode = stringify <<< toJson

toJson :: CalypsoValue -> Json
toJson = case _ of
  PVNull -> AJ.jsonNull
...
fromJson :: Json -> Maybe CalypsoValue
fromJson j =
  caseNull
    <|> caseBool
    <|> caseNumber
...
fromObject :: Object Json -> Maybe CalypsoValue
fromObject o =
  -- { "$ctor": "Name", "args": [...] }
