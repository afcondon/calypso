// Path resolves from the bundled output location (output/Calypso.Frontend.RenderView/foreign.js),
// not the source tree. spago copies this file there before esbuild runs.
import { runAtelierForce } from "../Calypso.Frontend.ForceSim/index.js";
...
function renderForce(container, spec) {
  ...
  // runAtelierForce is compiled from Calypso.Frontend.ForceSim via
